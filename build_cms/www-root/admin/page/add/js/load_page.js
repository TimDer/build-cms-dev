    ...
    /* ============================== functions ============================== */
        ...
        class load_blocks {
                ...
                $.each(blocks_object, function (key, value) {
                    if (value !== building_blocks_area) {
                        if (value.block_type === "wysiwyg") {
                            self.load_wysiwyg(value, building_blocks_area);
                        }
                        else if (value.block_type === "plain_text") {
                            self.load_plain_text(value, building_blocks_area);
                        }
                        else if (value.block_type === "image") {
                            self.load_image(value);
                        }
                        else if (value.block_type === "create_columns") {
                            self.load_create_columns(value, building_blocks_area);
                        }
                        else if (value.block_type === "subcategories") {
                            self.load_subcategories(value, building_blocks_area);
                        }
                    }
                });
            }
            ...
            load_wysiwyg (block_object) {
                ...
                else if (block_object.building_blocks_area === "category-info") {
                    $("#building-blocks-area-category-info").append(function () {
                        return block_html;
                    });
                }
                else {
            ...
            load_plain_text (block_object, building_blocks_area) {
