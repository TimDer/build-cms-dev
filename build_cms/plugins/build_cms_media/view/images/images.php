        ...
        <div class="main_container">
            <div class="upload_container bootstrap">
                <div class="container-fluid">
                    <form action="<?php echo config_url::BASE("/admin/media/images/upload"); ?>" method="post" enctype="multipart/form-data" id="images_upload_form">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <input type="submit" class="form-control btn btn-primary" max_files="<?php echo ini_get("max_file_uploads"); ?>" id="images_upload_submit" value="Upload">
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="images_container">
                <?php echo build_cms_media_pluginModal::$images_html; ?>
            </div>
        </div>
    </div>
</div>
...
<div class="data_modal_container bootstrap">
    ...
    <!-- ============================== data modal ============================== -->
    <div class="modal fade" id="data_modal" tabindex="-1" role="dialog" aria-labelledby="Image" aria-hidden="true">
    ...
    <!-- ============================== error modal ============================== -->
    <div class="modal fade" id="error_modal" tabindex="-1" role="dialog" aria-labelledby="Image" aria-hidden="true" open_modal="<?php echo build_cms_media_pluginModal::$open_error_modal; ?>">
