/* ============================== sortable ============================== */
    function td_sortable() {
        ...
        $(".sortable-building-blocks").sortable({
            ...
            stop: function () {
                // reload one wysiwyg
                $("#building-blocks-area, #sortable-building-blocks-left, #sortable-building-blocks-right").find("#wysiwyg_block_sortable").each(function () {
                    $(this).removeAttr("id");
                ...
                // reload wysiwyg in a "create_columns" block
                $("#building-blocks-area, #sortable-building-blocks-left, #sortable-building-blocks-right").find("#create_columns-wysiwyg_block_sortable").each(function () {
                    $(this).removeAttr("id");
...
$(document).ready(function () {
    ...
    /* ============================== droppable ============================== */
        ...
        $("#building-blocks-area").droppable({
            drop: function (event, ui) {
                td_droppable("#building-blocks-area");
            }
        });

        $("#sortable-building-blocks-left").droppable({
            drop: function (event, ui) {
                td_droppable("#sortable-building-blocks-left");
            }
        });

        $("#sortable-building-blocks-right").droppable({
            drop: function (event, ui) {
                td_droppable("#sortable-building-blocks-right");
            }
        });
    /* ============================== /droppable ============================== */
