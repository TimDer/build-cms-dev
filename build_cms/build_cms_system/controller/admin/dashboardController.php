...
class dashboardController extends controller {
    ...
    public static function add_edit_user_icon_submit() {
        ...
        $fileResult = files::upload_to_dir(
            config_dir::BUILD_CMS_SYSTEM("/www-root/admin/dashboard/user_icons"),
            $_FILES['add_icon'],
        ...
        if (is_string($fileResult)) {
            ...
            if ( $currentFileName !== "" && file_exists(config_dir::BUILD_CMS_SYSTEM("/www-root/admin/dashboard/user_icons/" . $currentFileName)) ) {
                unlink( config_dir::BUILD_CMS_SYSTEM("/www-root/admin/dashboard/user_icons/" . $currentFileName) );
            }
            echo "Success";
        }
    ...
    public static function delete_user_icon_submit() {
        ...
        unlink( config_dir::BUILD_CMS_SYSTEM("/www-root/admin/dashboard/user_icons/" . $data["user_icon"]) );
