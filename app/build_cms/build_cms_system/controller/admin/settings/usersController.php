...
class usersController extends controller {
    ...
    public static function submit_delete_a_user() {
        ...
        if ( !empty( $user_icon ) && file_exists( config_dir::BUILD_CMS_SYSTEM( "/www-root/admin/dashboard/user_icons/" . $user_icon ) ) ) {
            unlink( config_dir::BUILD_CMS_SYSTEM( "/www-root/admin/dashboard/user_icons/" . $user_icon ) );
        }
    }
}